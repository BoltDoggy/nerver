...
dotenv_1["default"].config({ path: path_1["default"].resolve(CWD, '.env.local') });
    ...
    return __generator(this, function (_a) {
        ...
        if (ret) {
            return [2 /*return*/, util_1.reImport(truePath)
                    .then(function (mod) { return util_1.isFun(mod) && mod.bind(_this)(ctx, next) || next(); })["catch"](function (err) {
                    next();
...
app.use(function (ctx) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var _this = this;
    return __generator(this, function (_a) {
        truePath = path_1["default"].join(CWD, ctx.path + ".ts").replace('/.ts', '/index.ts');
        return [2 /*return*/, util_1.reImport(truePath)
...
console.log("Nerver Mode: " + process.env.mode);
