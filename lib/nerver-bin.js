...
app.use(function (ctx, next) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 4, , 5]);
                if (!(path_1["default"].extname(ctx.url) !== '.ts')) return [3 /*break*/, 3];
                return [4 /*yield*/, next()];
            case 2:
                _a.sent();
                _a.label = 3;
...
app.use(function (ctx) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var _this = this;
    return __generator(this, function (_a) {
        truePath = path_1["default"].join(CWD, ctx.url + ".ts");
        return [2 /*return*/, util_1.reImport(truePath).then(function (mod) { return mod.bind(_this)(ctx); })];
    });
}); });
